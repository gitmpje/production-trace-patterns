...
if __name__=="__main__":
    ...
    patterns_combined = [
        ...
        ("interval_aggregate-attribute.rq", {"IntervalStartType": PTP.TrackIn, "IntervalEndType": PTP.TrackOut, "attribute": PTP.measuredValue}),
    ]
    ...
    for query_file,bindings in patterns_combined:
        ...
        if r.type == "CONSTRUCT":
            ...
            r.serialize(f"results_combined/{query_file.replace('.rq', '')}_{hash(str(bindings))}.csv", format="csv")
